...
<div class="row">
  <div class="col-md-12 category-body">
    ...
    <ul class="list-group">
<!-- Anfang Postitrect -->
      <li class="list-group-item">Post-it 76x127mm Coloured
...
<!-- Anfang Stabilopens -->
  ...
  <!-- Anfang Beschreibung Mobile Kit -->
      ...
      <form method="POST" action="http://www.amazon.de/exec/obidos/dt/assoc/handle-buy-box=B000KTBH7G">
         <input type="hidden" name="asin.<?php echo $postitrect_asin  ?>" value="1">
         <input type="hidden" name="asin.<?php echo $whitemarker_asin ?>" value="1">
         <input type="hidden" name="asin.<?php echo $stabilopens_asin ?>" value="1">
         <input type="hidden" name="asin.<?php echo $easyflip_asin  ?>" value="1">
         <input type="hidden" name="tag-value" value="dtmaterial-21">
         <input type="hidden" name="tag_value" value="dtmaterial-21">
         <input type="hidden" name="dev-tag-value" value="D17NDHV0Z9CL29"/>
         <button class="btn btn-default" type="submit" name="submit.add-to-cart">
           Add bundle to Amazon shopping cart       <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>
         </button>
       </form>
    </div>
  </div>
  <!-- Anfang Premium Bundle -->
  <div class="row">
    <div class="col-md-12 category-head">
    <h2>Premium Business Bundle</h2>
  Have a look at the following Design Thinking equipment bundle if money is not the issue for you and you want to get the best Design Thinking Material.
  </div>
</div>
<div class="row">
  <div class="col-md-12 category-body">
  </br>
    For one team space you will need: </br> </br>
    <ul class="list-group">
<!-- Anfang Postitrect -->
      <li class="list-group-item">Rectangled Post-Its 76x127mm Coloured x 2
        <a class="buy pull-right" target="_blank" href="<?php echo $postitrect_link; ?>">Amazon</a>
        <a class="more pull-right" data-toggle="collapse" href="#postitrect2">More info</a>
      </li>
        <div id="postitrect2" class="collapse">
          <div class="description_container">
            <?php echo $postitrect_desc; ?>
          <a href="postits.php"> on our site for Design Thinking post-its</a>.
          </div>
          <?php echo $postitrect_picture; ?> </br>
          <a class="" data-toggle="collapse" href="#postitrect2">Collapse</a>
        </div>
<!-- Anfang Normal squared -->
        <li class="list-group-item">Post-It Squared Standard Size
...
<!-- Anfang Big Rectangle -->
          <li class="list-group-item">Big Rectangle Post-It 200x149mm
...
<!-- Anfang Whiteboard Marker -->
        <li class="list-group-item">Whiteboard Marker x 2
          <a class="buy pull-right" target="_blank" href="<?php echo $whitemarker_link; ?>">Amazon</a>
          <a class="more pull-right" data-toggle="collapse" href="#whitemarker2">More info</a>
        </li>
          <div id="whitemarker2" class="collapse">
            <div class="description_container">
              <?php echo $whitemarker_desc; ?>
            </div>
            <?php echo $whitemarker_picture; ?> </br>
            <a class="" data-toggle="collapse" href="#whitemarker2">Collapse</a>
          </div>
<!-- Anfang Stabilopens -->
        <li class="list-group-item">Stabilo pen 68 x 2
          <a class="buy pull-right" target="_blank" href="<?php echo $stabilopens_link; ?>">Amazon</a>
          <a class="more pull-right" data-toggle="collapse" href="#stabilopens2">More info</a>
        </li>
          <div id="stabilopens2" class="collapse">
            <div class="description_container">
              <?php echo $stabilopens_desc; ?>
            </div>
            <?php echo $stabilopens_picture; ?> </br>
            <a class="" data-toggle="collapse" href="#stabilopens2">Collapse</a>
          </div>
...
<!-- Anfang Easyflip -->
            <li class="list-group-item">EasyFlip Whiteboard Foil
              <a class="buy pull-right" target="_blank" href="<?php echo $easyflip_link; ?>">Amazon</a>
              <a class="more pull-right" data-toggle="collapse" href="#easyflip2">More info</a>
            </li>
              <div id="easyflip2" class="collapse">
                <div class="description_container">
                  <?php echo $easyflip_desc; ?>
                <a href="whiteboards.php"> on our page for whiteboards and alternatives. </a>.Even if this is a cheap alternative to whiteboards you should buy some of them for the premium bundle. It simply allows your team to get wild and transform the workspace the way they want it to be.
                </div>
                <?php echo $easyflip_picture; ?> </br>
                <a class="" data-toggle="collapse" href="#easyflip2">Collapse</a>
              </div>
      </ul>
      <form method="POST" action="http://www.amazon.de/exec/obidos/dt/assoc/handle-buy-box=B000KTBH7G">
         <input type="hidden" name="asin.<?php echo $postitrect_asin  ?>" value="2">
         <input type="hidden" name="asin.<?php echo $whitemarker_asin ?>" value="2">
         <input type="hidden" name="asin.<?php echo $stabilopens_asin ?>" value="2">
         <input type="hidden" name="asin.<?php echo $easyflip_asin  ?>" value="1">
         <input type="hidden" name="asin.<?php echo $postitbigrect_asin  ?>" value="1">
         <input type="hidden" name="asin.<?php echo $postitsq_asin  ?>" value="1">
         <input type="hidden" name="tag-value" value="dtmaterial-21">
         <input type="hidden" name="tag_value" value="dtmaterial-21">
         <input type="hidden" name="dev-tag-value" value="D17NDHV0Z9CL29"/>
         <button class="btn btn-default" type="submit" name="submit.add-to-cart">
           Add bundle (Without DT Line Whiteboard) to Amazon shopping cart       <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>
         </button>
       </form>
     </br>
     </br>
  ...
  <div class="col-md-4">
    ...
    <img class="category-picture"src="pictures/starterkit.jpg"/>
  </div>
  </div>
